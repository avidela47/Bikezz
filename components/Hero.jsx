...
const Hero = () => {
  return (
    <section className="py-48 md:py-0 md:h-[820px] relative overflow-hidden bg-primary/5 mb-[-200px]">
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          {/* text */}
          <div className="w-full xl:max-w-[580px] md:h-[820px] flex flex-col justify-center items-center">
            <h1 className="text-center xl:text-left mb-6 mt-[-180px]">
            ...
            <p className="mb-10 text-lg max-w-[508px] mx-auto text-center xl:text-left xl:mx-0">
              ...
              ipsum dolor sit amet consectetur adipisicing elit. Repellat quod.
            </p>
            {/* btn-group */}
